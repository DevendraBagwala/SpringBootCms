...
<%@ page import="com.divergentsl.springbootcms.entity.Drug"%>
...
<body
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link"
							aria-current="page" href="druginsert">Insert</a></li>
	...
	<div class="text-center mt-5">
		<form action="drugsearch" method="get"
		...
		<% 
			if(request.getAttribute("drug") != null) {
		...
		<div>
			...
			<ul class="list-group list-group-horizontal">
				...
				<li class="list-group-item"><%= drug.getId() %></li>
			</ul>
			
			<ul class="list-group list-group-horizontal">
				<li class="list-group-item">Name</li>
				<li class="list-group-item"><%= drug.getName() %></li>
			</ul>
