...
<%@ page import="com.divergentsl.springbootcms.entity.Appointment"%>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link" aria-current="page"
							href="appointmentinsert">Insert</a></li>
						<li class="nav-item"><a class="nav-link"
							href="appointmentsearch">Search</a></li>

						<li class="nav-item"><a class="nav-link active disabled"
							href="appointmentlist">List All</a></li>
			...
			<tbody>
				<c:forEach items="${allAppointments}" var="appointment">
					<tr>
						...
						<td><a href="appointmentdelete?id=${appointment.id}"
