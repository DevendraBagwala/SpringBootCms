...
<body
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link"
							aria-current="page" href="doctoroperateinsert">Insert</a></li>

						<li class="nav-item"><a class="nav-link disabled active" href="#">Search</a></li>

						<li class="nav-item"><a class="nav-link" href="doctoroperatelist">List
								All</a></li>
	...
	<div class="text-center mt-5">
		<form action="doctoroperatesearch" method="get"
			style="max-width: 480px; margin: auto;">

			<h1 class="h3 mb-3 font-weight-normal">Insert DoctorOperate Data</h1>
		...
		<div>
			...
			<ul class="list-group list-group-horizontal">
				...
				<li class="list-group-item"><%= doctor.getId() %></li>
			</ul>
			
			<ul class="list-group list-group-horizontal">
				<li class="list-group-item">Name</li>
				<li class="list-group-item"><%= doctor.getName() %></li>
			</ul>
